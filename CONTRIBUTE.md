...
Ziel ist es, unter Befolgung der Github Issues in Kombination mit [waffle.io](https://waffle.io) und über die Anwendung eines Git Flows das gesamte Konzept der Story in Mindmaps, Visualisierungen und (kurzen) Markdown-Files im Repository abzulegen.
